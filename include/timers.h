...
{
  struct timer	*tmr_next;	/* next in a timer chain */  //n ub tmrs_clrtimer
  clock_t 	tmr_exp_time;	/* expiration time */  //n ub tmrs_clrtimer  set_timer
  tmr_func_t	tmr_func;	/* function to call when expired */  //n ub tmrs_settimer  tmrs_clrtimer
...
_PROTOTYPE( clock_t tmrs_settimer,		(timer_t **tmrs, timer_t *tp, clock_t exp_time, tmr_func_t watchdog, clock_t *new_head)				);
