...
//n although its name implies more generality, is used only for constructing the messages used by notify.  
...
#if (CHIP == INTEL)
//n CopyMess is a programmer-friendly interface to the assembly language routine cp_mess in klib386.s.
//n ub mini_send
 ...
 */
  ...
  int function = call_nr & SYSCALL_FUNC;	/* get system call function */  //n function: SEND/RECEIVE/SENDREC...
  unsigned flags = call_nr & SYSCALL_FLAGS;	/* get flags */			//n NON_BLOCKING
