...
#define SYSCALL_FUNC	0x0F	/* mask for system call function */		//n sys_call
#define SYSCALL_FLAGS   0xF0    /* mask for system call flags */		//n sys_call
#define NON_BLOCKING    0x10	/* prevent blocking, return error */  //n ub mini_send
