...
#define	TSK_S	SMALL_STACK	/* system and clock task */   //n ub image[]
 ...
 */
 //n in main() the info in this table are retreived and set to corresponding proc table entries
 //n qs is quantum to run before dequeued and rescheduled(in ticks, see clock.c?
